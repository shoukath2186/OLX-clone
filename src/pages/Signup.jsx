...
function SignUp(){
    ...
    return(
        ...
        <h1 className=" m-4 text-3xl font-bold">Sign Up</h1>
        ...
        <button className="w-[360px] h-[48px] m-3 p-3 rounded bg-gray-400 font-bold flex justify-center items-center">SUBMIT </button>
        </form>
        <div>
            <p>
            ...
            <Link to='/login' className="text-blue-800">Log In</Link>
            </p>
        </div>
